...
%
% Syntax:  NewChrom = mutate(MUT_F, OldChrom, MutOpt, Repre)
%
% Input parameter:
...
%    Repre     - individual encoding (1 - adj, 2 - path)
% Output parameter:
%    NewChrom  - Matrix containing the chromosomes of the population
%                after mutation in the same format as OldChrom.


function NewChrom = mutateTSP(MUT_F, OldChrom, MutOpt, Repre);
...
for r=1:rows
	if rand<MutOpt
		NewChrom(r,:) = feval(MUT_F, OldChrom(r,:),Repre);
	end
end
